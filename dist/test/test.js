...
describe("make vivox token", () => {
    ...
    test('join', () => {
        expect(vivoxToken.join("jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 444000, new Date(Date.UTC(2016, 0, 1))))
    ...
    test('joinMuted', () => {
        expect(vivoxToken.joinMuted("jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 542680, new Date(Date.UTC(2016, 0, 1))))
    ...
    test('kick', () => {
        expect(vivoxToken.kick("beef", "jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 665000, new Date(Date.UTC(2016, 0, 1))))
        ...
        expect(vivoxToken.kickByAdmin("jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 8000, new Date(Date.UTC(2016, 0, 1))))
    ...
    test('kick all user from channel', () => {
        expect(vivoxToken.kickAllUserFromChannelByAdmin(ChannelType_1.default.NonPositionalChannels, "testchannel", 729614, new Date(Date.UTC(2016, 0, 1))))
    ...
    test('mute', () => {
        expect(vivoxToken.mute("beef", "jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 123456, new Date(Date.UTC(2016, 0, 1))))
        ...
        expect(vivoxToken.muteByAdmin("jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 654321, new Date(Date.UTC(2016, 0, 1))))
    ...
    test('mute all user from channel', () => {
        expect(vivoxToken.muteAllUserFromChannel("beef", ChannelType_1.default.NonPositionalChannels, "testchannel", 102938, new Date(Date.UTC(2016, 0, 1))))
        ...
        expect(vivoxToken.muteAllUserFromChannelByAdmin(ChannelType_1.default.NonPositionalChannels, "testchannel", 825647, new Date(Date.UTC(2016, 0, 1))))
    ...
    test('mute all user from channel exclude one user', () => {
        expect(vivoxToken.muteAllUserFromChannelExcludeOneUser("beef", "jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 675849, new Date(Date.UTC(2016, 0, 1))))
        ...
        expect(vivoxToken.muteAllUserFromChannelExcludeOneUserByAdmin("jerky", ChannelType_1.default.NonPositionalChannels, "testchannel", 961734, new Date(Date.UTC(2016, 0, 1))))
